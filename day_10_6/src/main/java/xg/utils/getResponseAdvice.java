...
public class getResponseAdvice implements ResponseBodyAdvice<Object> {
    ...
    //该方法用于判断哪些控制器需要被处理,true表示需要被处理
    public boolean supports(MethodParameter methodParameter, Class<? extends HttpMessageConverter<?>> aClass) {
        return true;
    }

    @Override
    public Object beforeBodyWrite(Object body, MethodParameter me, MediaType m, Class<? extends HttpMessageConverter<?>> a, ServerHttpRequest request, ServerHttpResponse ser) {
